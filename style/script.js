...
const messages = [
  "Nếu chấm e trên thang điểm 10,\n Thì hôm nay e dc 20/10🔥🔥",
  "Các bạn thật phi thường",
  "Chúc các bạn tràn đầy niềm vui, hạnh phúc",
  "Là mặt trời thì tỏa nắng, người như bạn chắc chắn xink🩷🩷",
  "Khách gì đến 3 tháng 1 lần? Khách quý🐸"
];
const fallingTexts = [];
